...
public class SpecialVendingMachineController {
    ...
    private SpecialVendingMachineView vendingMachineView;
    private SpecialVendingMachine vendingMachine;
    private SpecialVendingMachine startingStock;
    ...
    public SpecialVendingMachineController(SpecialVendingMachineView vendingMachineView, SpecialVendingMachine vendingMachine, SpecialVendingMachine startingStock) {
        ...
        this.vendingMachineView.setPurchaseBtn2Listener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                option = 3;
                customer.customerMenu(vendingMachine, option);
