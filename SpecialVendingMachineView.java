...
public class SpecialVendingMachineView {
	...
	private JButton featureBtn, maintenanceBtn, displayBtn, purchaseBtn, purchaseBtn2, backBtn, 
    ...
    public SpecialVendingMachineView() {
        ...
        // Test Panel
		this.titleLbl = new JLabel("Special Vending Machine");
        ...
        this.purchaseBtn2 = new JButton("Purchase Buritto");
		this.purchaseBtn2.setPreferredSize(new Dimension(220, 30));
        ...
        CustomerPanel.add(purchaseBtn2);
    ...
    public void setPurchaseBtn2Listener (ActionListener actionListener) {
        this.purchaseBtn2.addActionListener(actionListener);
    }
